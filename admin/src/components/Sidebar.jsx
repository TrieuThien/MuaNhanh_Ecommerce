...
const Sidebar = () => {
      ...
      return (
        <div key={item.title} className="mb-2">
          <button
            ...
            className="w-full flex items-center justify-between gap-2 lg:gap-3 px-2 lg:px-3 py-2 lg:py-2.5 mx-1 lg:mx-2 rounded-lg text-gray-700 hover:bg-gray-50 transition-all duration-200 group"
          >
            <div className="flex items-center gap-2 lg:gap-3 min-w-0">
              <span className="text-base lg:text-lg transition-transform group-hover:scale-110 flex-shrink-0">
                {item.icon}
              </span>
              <span className="hidden lg:inline-flex font-medium truncate">
                {item.title}
              </span>
            </div>
            <span className="hidden lg:inline-flex flex-shrink-0">
  ...
  return (
    <div className="w-full bg-white border-r border-gray-200 flex flex-col overflow-x-hidden">
      {/* Logo/Header */}
      <div className="p-3 lg:p-4 border-b border-gray-200 bg-gradient-to-r from-gray-50 to-white flex-shrink-0">
        <div className="flex items-center gap-2 lg:gap-3">
          <div className="w-8 h-8 lg:w-10 lg:h-10 bg-gradient-to-br from-black to-gray-700 rounded-lg lg:rounded-xl flex items-center justify-center shadow-lg">
            <FaBox className="text-white text-sm lg:text-lg" />
          </div>
      ...
      {/* Quick Stats */}
      <div className="p-3 lg:p-4 border-b border-gray-100 hidden lg:block flex-shrink-0">
      ...
      {/* Navigation */}
      <div className="flex-1 py-2 lg:py-4 overflow-y-auto overflow-x-hidden">
      ...
      {/* Footer */}
      <div className="p-3 lg:p-4 border-t border-gray-100 bg-gray-50 flex-shrink-0">
        {/* User Info */}
        {/* {user && (
          <div className="hidden lg:flex items-center gap-3 mb-3 p-2 bg-white rounded-lg">
        ...
        <div className="mb-3">
          <button
            ...
            className="w-full flex items-center justify-center lg:justify-start gap-2 lg:gap-3 px-2 lg:px-3 py-2 lg:py-2.5 bg-red-600 hover:bg-red-700 text-white rounded-lg transition-colors duration-200 group"
          >
            <FaSignOutAlt className="text-sm lg:text-base group-hover:scale-110 transition-transform duration-200" />
        ...
        <div className="text-center text-xs text-gray-400">
          <div className="hidden lg:block">
            ...
            <p className="text-gray-500">© 2025 MuaNhanh Admin v1.0.0</p>
          </div>
